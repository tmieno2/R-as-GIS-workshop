...
## Topological Relations: `st_intersects()`
...
## Topological Relations: `st_is_within_distance()`
...
## Topological Relations: `st_nearest_feature()`  
...
## Topological Relations: Exercises
...
## Spatial Subsetting and Cropping
...
## Spatial Subsetting: polygons (source) vs polygons (target)
...
ggplot() +
  ...
  geom_sf(data = hp_boudary, fill = "blue" ,alpha = 0.4) +
  theme_void()
```

:::

## Spatial Subsetting: points (source) vs polygons (target)
...
## Spatial Subsetting: lines (source) vs polygons (target)
